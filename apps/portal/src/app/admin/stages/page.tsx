      ...
      <div style={{ ...adminPage, maxWidth: 820 }}>
        ...
        <ul style={list}>
          {(stages.data ?? []).map((stage) => (
            ...
            >
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: fontWeight.bold, fontSize: fontSize.sm }}>
                  {stage.label}
                ...
                */}
                {stage.caution ? (
                  ...
                  <p style={{ margin: '4px 0 0', fontSize: fontSize.sm, color: color.bodyBrown }}>
        ...
        <h2 style={{ ...pageTitle, fontSize: fontSize.md, marginTop: 8 }}>Sequence</h2>
        <p style={intro}>
        ...
        {[...byType.entries()].map(([auditType, steps]) => (
          <div key={auditType} style={{ ...card, padding: 16 }}>
            <div style={{ fontWeight: fontWeight.bold, fontSize: fontSize.sm, marginBottom: 8 }}>
            ...
            <ol style={{ ...list, gap: 0, paddingLeft: 0, listStyle: 'none' }}>
              {steps.map((step) => (
                <li key={step.key} style={step_}>
                  ...
                  <span style={{ flex: 1, fontSize: fontSize.sm }}>{step.label}</span>
