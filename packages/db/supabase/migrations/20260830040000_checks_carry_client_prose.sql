...
--
--   client_finding    what happened, stated as a fact — "Did not say they were
--                     paid, or name the agency."
...
from (values
  ('APR-01',
   'The ID badge was not visible before the fundraiser approached people.',
  ...
  ('OPN-03',
   'The charity was named in a way that could be mistaken for another organisation.',
   'A shortened name that resembles a better-known charity is treated as misleading, whether or not it was meant that way.'),
  ('PIT-01',
   'Claims made about the charity''s work were exaggerated or unsupported.',
